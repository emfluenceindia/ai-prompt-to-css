...
- 🔒 **Safe injection**: Uses WordPress APIs (`wp_get_custom_css`, `wp_update_custom_css_post`) to ensure compatibility.
- 🗂 **Marker‑based management**: Each AI‑generated block is wrapped with identifiable markers for easy updates/removal.
- ⚡ **Prompt history**: Keeps track of prompts used for CSS generation.
- 🌍 **Multilingual ready**: Supports translation via `Text Domain`.
